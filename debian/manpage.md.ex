% penetration-app(SECTION) | User Commands
%
% "May 21 2023"
...
penetration-app - program to do something

# SYNOPSIS

**penetration-app** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**penetration-app** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **penetration-app** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**penetration-app** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    penetration-app. See **foo.conf**(5) for further details.
...
**penetration-app** provides some return codes, that can be used in scripts:
...
kasinadhsarma <exploit0xffff@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 kasinadhsarma
