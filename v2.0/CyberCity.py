...
from YoutubeChannelsPage import YoutubeChannelsPage
...
from HardwareToolsPage import HardwareToolsPage
...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.stack.add_named(scroll, "Main Page")  # Adding scroll to self.stack
    ...
    def open_page(self, button, page_name):
        ...
        if page_name not in self.added_pages:
            page_classes = {
                ...
                "Youtube Channels": YoutubeChannelsPage,
                "HardwareTools": HardwareToolsPage
            }
